...
export const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
        ...
        <button onClick={() => navigate('/movies')} className="flex items-center gap-1 px-6 py-3 text-sm bg-primaary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer">
            Explore Movies 
